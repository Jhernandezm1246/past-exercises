        ...
        while cycle == "Y":
            ...
            def calculator(selection, num, cycle):
                ...
                try:
                    ...
                    print(f"Error [TyperError]: You tried to enter a string and should only add numbers from 1 to 5 this can be cause by adding the Y to the cycle request if thats the case please ignore this error and proceed")

            calculator(selection, num)
