class Class_Room():
    ...
    def __init__(self):
        self.new_group_of_students = []
        

    def add_student(self,new_student):

        self.new_group_of_students.append(new_student)


    def all_student_information(self,selection):

        if selection == 2:

            for student in self.new_group_of_students:
                print(f"Name : {student.name}, section : {student.section}")


    def top_three_students_average_scores(self,selection):
        ...
        if selection == 3:
            ...
            for student in self.new_group_of_students:
                ...
                science = float(student.science_score)
                spanish = float(student.spanish_score)
                english = float(student.english_score)
                history = float(student.history_score)
    ...
    def all_students_average_scores(self,selection):
            ...
            for student in self.new_group_of_students:
                ...
                if student_name == validation_name and student_section == validation_section:
                    ...
                    if delete_validation == "Y":
                        self.new_group_of_students.remove(student)
                        print("Student deleted as requested")

    def all_students_average_scores_lower_than_sixty(self,selection):
        ...
        if selection == 8:
            ...
            for student in self.new_group_of_students:
                ...
                if science < 60 or spanish < 60 or english < 60 or history < 60:
                    print(f"Student name: {student.name},student section: {student.section}, science score: {student.spanish_score}, spanish score: {student.spanish_score}, english score: {student.english_score}, history score: {student.history_score}")



class Student():

    def __init__(self,name,section,science_score,spanish_score,english_score,history_score):
...
def new_student_info(selection,class_room):
